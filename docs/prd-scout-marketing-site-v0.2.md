...
**Version:** 0.2 · July 18, 2026
**Owner:** Nick
**Status:** Draft — synced with Scout PRD v0.3
...
**Changes in 0.2:** verb slate synced (`add, archive, list, start, explain, review, setup` — seven plain-English verbs; "tracks" retired as a command, retained as the concept in copy), Beat 4.5 handoff updated, Beat 5 heading restored, ships-empty framing in the gallery/footer, courier pattern named consistently (per Scout PRD §7.3), patch code-renderer mechanic captured, discovery-not-curation stance applied to the Later phase.
...
4. **Review** — before you ship, `/scout review` checks the project for anything you missed.
